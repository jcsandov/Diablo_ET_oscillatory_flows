...
grid_folder="/home/jsandoval/02_PDRA/Diablo_OASBL"
source_folder="/home/jsandoval/02_PDRA/Diablo_OASBL"
...
if [ -f rescaling.ind ]; then
  # Remove the file.
  rm -f rescaling.ind
fi

if [ -f sp_shifts.ind ]; then
  # Remove the file.
  rm -f sp_shifts.ind
fi

if [ -f lambda_shifts.ind ]; then
  # Remove the file.
  rm -f lambda_shifts.ind
fi
